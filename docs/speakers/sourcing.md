 ...
 * @takcastel : :+1: ok, ça a l'air intéressant et dans le thème.
 ...
 * @takcastel : :+1: must have ! vraiment ;)
 ...
 * @bertrandkeller : rien contre, mais quel sujet ?
 * @takcastel : je connais, j'adore, mais je ne vois pas le sujet ?
 ...
 * @takcastel : :1: franchement, le conflit d'intérêt ne me dérange pas du tout. Je dis oui surtout si ça peut rassembler deux communautés qui sont déjà proches historiquement (Framasoft et Sud Web, c'est un peu les mêmes personnes ^^)
 ...
 * @takcastel :+1: il est motivé et sympa, j'ai discuté un peu avec sur linkedin, j'aime beaucoup sa démarche humour :)
 * @bertrandkeller : :-1: pas opposé, que peut-on lui demander qui rentre dans notre envie pour 2019 ?
